from sqlalchemy import Column, Integer, String, Float, ForeignKey, DateTime, Index, Date, Boolean
...
class Customer(Base, TimestampMixin):
    ...
    pontos = Column(Float, default=0.0, nullable=False)  # Saldo atual
    ...
    valor_gasto_atual = Column(Float, default=0.0, nullable=False)  # Para promoção por valor
